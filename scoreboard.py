...
class Scoreboard:
    ...
    def show_score(self):
        """Draw the score and ships/lives to the screen."""
    ...
    def prep_level(self):
        ...
        self.level_image = self.font.render(str(level_str), True, self.text_colour, self.ai_settings.bg_colour)

        # Position the level text below the score text.
